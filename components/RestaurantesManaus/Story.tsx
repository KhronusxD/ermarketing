...
import { SectionLabel, IMAGES } from './shared';
                ...
                <div className="grid lg:grid-cols-12 gap-12 items-center">
                    ...
                    >
                        ...
                        <div className="absolute top-0 left-0 w-[70%] h-[60%] rounded-3xl overflow-hidden border border-[#D4A574]/20 shadow-[0_30px_70px_-15px_rgba(0,0,0,0.8)]">
                            <img src={IMAGES.camera_bts} alt="Captação audiovisual" className="w-full h-full object-cover" />
                        ...
                        >
                            <img src={IMAGES.team_meeting} alt="Reunião de equipe" className="w-full h-full object-cover" />
                        ...
                        >
                            <img src={IMAGES.edit_screen} alt="Edição" className="w-full h-full object-cover" />
                            <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
                        </motion.div>
                        ...
                        >
                            <img src={IMAGES.plating} alt="Prato" className="w-full h-full object-cover" />
                        </motion.div>
                    </motion.div>
