        ...
        <div className="min-h-screen flex items-center justify-center p-4 bg-[#050505] relative overflow-hidden">
            <div className="w-full max-w-md bg-[#0A0A0A] border border-white/10 rounded-2xl p-8 shadow-2xl z-10 relative">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label htmlFor="name" className="block text-xs font-medium text-gray-400 mb-1 ml-1">NOME COMPLETO</label>
                        <input
                            required
                            type="text"
                            name="name"
                    ...
                    <div>
                        <label htmlFor="email" className="block text-xs font-medium text-gray-400 mb-1 ml-1">E-MAIL CORPORATIVO</label>
                        <input
                            required
                            type="email"
                            name="email"
                    ...
                    <div>
                        <label htmlFor="website" className="block text-xs font-medium text-gray-400 mb-1 ml-1">SITE DA EMPRESA</label>
                        <input
                            required
                            type="url"
                            name="website"
