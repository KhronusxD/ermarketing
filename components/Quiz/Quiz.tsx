                        ...
                        <div className="space-y-3">
                            {question.options.map((option, index) => (
                                <motion.button
                                    ...
                                    className="w-full text-left p-6 rounded-xl border border-white/10 bg-white/5 backdrop-blur-md group flex items-center justify-between transition-all duration-200 shadow-lg hover:shadow-er-red/10"
                                >
